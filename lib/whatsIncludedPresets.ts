// Quick Add presets for the What's Included admin editor only. Admin-only
// convenience data — selecting one just materializes a normal canonical
// ContentItem ({icon, text}); nothing here is a preset id or business rule.
// components/ProductPage.tsx must never import this file.
