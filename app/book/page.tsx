...
// Format a Date as YYYY-MM-DD using LOCAL calendar fields (never UTC-shift via toISOString,
// which rolls the date back a day for any guest in a timezone ahead of UTC — e.g. Thailand +7, India +5:30)
